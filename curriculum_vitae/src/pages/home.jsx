          ...
          <div className="row g-0 card-bg">
            ...
            <div className="col">
              <div className="card-body pe-3 pb-0">
                <h5 className="card-title titulo">{dataView?.applicant?.name.toUpperCase()}</h5>
                <p className="card-text fst-italic small-paragraph">{dataView?.applicant?.bio.toUpperCase()}</p>
              </div>
            </div>
